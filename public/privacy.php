  ...
  <div class="shell">
    ...
    <main class="center">
      ...
      <article class="post legal">
        ...
        <p class="post-text">Five Minutes with Bob is meant to be a calm, simple place, and we keep the data
        ...
        <h2>123Greetings</h2>
        <p class="post-text">Five Minutes with Bob is powered by 123Greetings. If you follow a link from our footer to a
